(() => {
    ...
    paralaxMouseInit(t) {
      t.forEach((t) => {
        ...
        !(function e() {
          (l += ((i - l) * n) / 1e3),
            (r += ((d - r) * n) / 1e3),
            (t.style.cssText = `transform: translate3D(${(a * l) / (o / 10)}%,${
              (c * r) / (s / 10)
            }%,0) rotate(0.02deg);`),
    ...
    t.addEventListener("click", () => {
      t.classList.toggle("active"),
        t.classList.contains("active") &&
          (t.querySelector(".item-how__image .video1").play(),
          t.querySelector(".item-how__image .video2").play());
    });
  });
  ...
  async function copyContactAdressFunc() {
    try {
      const tokenValue = "5ybzWUbbVVXLTzuH3BiKyHwxnjfqtu9mCHnYZKf5fPng";
  ...
  (g = navigator.userAgent).includes("Firefox") ||
    g.includes("SamsungBrowser") ||
    g.includes("Opera") ||
    g.includes("OPR") ||
    g.includes("Edge") ||
    g.includes("Edg") ||
    g.includes("Chrome") ||
    (g.includes("Safari") && document.documentElement.classList.add("safari"));
  var g;
  (window.FLS = !1),
